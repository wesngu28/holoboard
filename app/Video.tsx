  ...
  return vid ? (
    <div className="mb-[15vh] w-[90vw] h-[80vh] md:h-[66.625vh] p-4 flex flex-col md:flex-row items-center justify-center">
      <iframe
        ...
        src={`https://www.youtube.com/embed/${videoContext?.video?.video}`}
      ...
      <iframe
        ...
        src={`https://www.youtube.com/live_chat?v=${videoContext?.video?.video}&embed_domain=holoboard.vercel.app`}
      ></iframe>
    </div>
  ) : null
}
